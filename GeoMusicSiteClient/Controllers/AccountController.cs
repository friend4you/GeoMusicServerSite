...
namespace GeoMusicSiteClient.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        {
            if (Request.Headers.AllKeys.Contains("client") && Request.Headers["client"].Equals("mobile"))
            {
                return await MobileRegister(model);
            }
            else
            {
                return await WebRegister(model);
            }
        }

        private async Task<ActionResult> MobileRegister(RegisterViewModel model)
        {
            var map = new Dictionary<String, Object>();
        ...
        private async Task<ActionResult> WebRegister(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
